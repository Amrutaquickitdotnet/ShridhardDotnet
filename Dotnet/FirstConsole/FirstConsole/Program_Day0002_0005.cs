...
namespace FirstConsole
{
    ...
    class Program_Day0002_0005
    {
        static void Main_0005(string[] args)
        {
         ...
         var result= GetCondition(employeeNames, "A", "StartsWith");
            ...
            List<int> resultIntList = GenricMethods.ToGetList(GenricMethods.GetCondition(employeeIntListNames, x => x > 2));
